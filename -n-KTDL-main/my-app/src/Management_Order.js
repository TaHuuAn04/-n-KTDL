                ...
                <div className="backgr-management">
                    <div className="topay-wrap">
                        ...
                        {/* <div className="management-navbar">
                            ...
                            <Link to="/Order_Management_ToShip" className="navbar-toship">To ship</Link>
                        ...
                        {sales ? (
                                        ...
                                        <div className="manage-topay">
                                            ...
                                            <div className="button-management">
                                                <div className="management-order-button">
                                                    ...
                                                    <span className="cancel-management" style={{backgroundColor: "#c3abd8", color: "white"}}
                                                    >{sale.Status}</span>
                                                </div>
                            ...
                            <p style={{justifySelf: "center", fontSize: "25px", padding: "80px"}}>Bạn chưa có đơn hàng đang giao!</p>
                        )}
