...
function OrderManagementCancelled() {
                ...
                <div className="backgr-management">
                    <div className="topay-wrap">
                        ...
                        <div className="management-navbar">
                            ...
                            <Link to="/Order_Management/Completed">Completed</Link>
                            <Link to="/Order_Management/Cancelled" className="navbar-cancelled">Cancelled</Link>
                        </div>

                        {sales ? (
                            sales.map((sale) => (
                                <div key={sale["Order ID"]}>
                                    ...
                                    <div className="manage-topay-backgr">
                                        <div className="manage-topay">
                                            ...
                                            <div key={sale["Order ID"]}>
                                                <div key={sale["Order ID"]} className="product-detail-management-main">
                            ...
                            <p style={{justifySelf: "center", fontSize: "25px", padding: "80px"}}>Bạn không có đơn hàng đã hủy!</p>
                        )}
...
export default OrderManagementCancelled;
