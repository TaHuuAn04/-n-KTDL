                ...
                <div className="backgr-management">
                    <div className="topay-wrap">
                        ...
                        <div className="management-navbar">
                            <Link to="/Order_Management/ToPay" className="navbar-topay">Processing</Link>
                        ...
                        {sales ? (
                                        ...
                                        <div className="manage-topay">
                                            ...
                                            <div className="button-management">
                                                <div className="management-order-button">
                                                    <button className="cancel-management"
                                                        onClick={() => cancelOrder(sale["Order ID"])}
                                                        style={{backgroundColor: "rgb(233, 91, 91)",
                                                            borderColor: "rgb(157, 21, 21)",
                                                            color: "white"
                                                        }}
                                                    >Cancel
                                                    </button>
                            ...
                            <p style={{justifySelf: "center", fontSize: "25px", padding: "80px"}}>Bạn không có đơn hàng đang được xử lý!</p>
                        )}
