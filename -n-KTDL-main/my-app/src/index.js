...
import Manage_Order_Returned from './Manage_Order_Returned';
import Manage_Order_Cancelled from './Manage_Order_Cancelled';
import Management_Order from './Management_Order';
  ...
  <React.StrictMode>
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="Manage_Order_Returned" element={<Manage_Order_Returned />} />
        <Route path="Manage_Order_Cancelled" element={<Manage_Order_Cancelled />} />
        <Route path="Management_Order" element={<Management_Order />} />
      </Routes>
    </BrowserRouter>
